...
| PLAT-PB-017 | High | Infrastructure | Platform Operations | Platform Operations Domain Architecture | Milestone 14 | Planned | PLAT-13.6.3B evidence; Infrastructure Registry; PLAT-14.0A Architecture Gatekeeper review and publication |
| PLAT-PB-013 | High | Infrastructure | Container Metrics | Container Metrics Modernization | Milestone 14 | Blocked | PLAT-PB-017; PLAT-14.0A publication and PLAT-14.1A architecture alignment; PLAT-13.6.3B |
...
PLAT-14.0A separates Infrastructure Registry declared state, provider observations, normalized one-signal evidence, reconciliation, deterministic health, and advisory intelligence. PLAT-14.1A remains unstarted and blocked until the domain architecture is published and its provider implementation scope is aligned without deleting approved telemetry work.
