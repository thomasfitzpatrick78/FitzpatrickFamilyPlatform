...
- Represent Prometheus, Node Exporter, and cAdvisor as active after PLAT-13.6.2 live validation evidence.
- Keep Grafana, backup automation, restore validation, alerts, and controlled updates as planned until future implementation approval.
...
| Version | Description |
|---------|-------------|
| 1.4 | Updated registry requirements for completed PLAT-13.6.2 Metrics Foundation. |
